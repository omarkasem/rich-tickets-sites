<?php
/**
 * Snippets class for Rich Tickets Sites
 */
...
class RTS_Snippets {
    ...
    public function __construct() {
        ...
        // Posts List Shortcode snippets
        add_filter( 'get_the_archive_title', array( $this, 'my_theme_archive_title' ) );
        add_shortcode( 'events_list_shortcode', array( $this, 'display_events_list' ) );
        add_shortcode( 'lastposts_list_shortcode', array( $this, 'display_lastest_posts' ) );
        add_shortcode( 'venuesposts_list_shortcode', array( $this, 'display_venuesposts_posts' ) );
        add_action( 'wp_ajax_get_event_pages', array( $this, 'get_event_pages' ) );
        add_action( 'wp_ajax_nopriv_get_event_pages', array( $this, 'get_event_pages' ) );


        // Get Categories List Snippets
        add_shortcode( 'categories_list_shortcode', array( $this, 'display_categories_list' ) );
        add_shortcode( 'post_featured_img_shortcode', array( $this, 'post_featured_img' ) );
    ...
    function display_events_list($atts){
        ...
        wp_reset_postdata();
        $string .= '</div>'; // Close the elementor-compatible container
        return $string;
    }
